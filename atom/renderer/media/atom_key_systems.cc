...
// ELECTRONISED BY: THE FOLLOWING IS A COPY PASTE OF chrome_key_systems.cc with
// relevant complier flags modified/removed (ie allow PROPRIETARY_CODECS by
// default, and all CHROME_OS and ANDROID inclusions removed).

#include "atom/renderer/media/atom_key_systems.h"
...
#include "chrome/common/render_messages.h"                //TODO-ELECTRON: OUT OF COMPILER SCOPE ?
#include "components/cdm/renderer/widevine_key_systems.h" //TODO-ELECTRON: OUT OF COMPILER SCOPE ?
#include "content/public/renderer/render_thread.h"
#include "media/base/eme_constants.h"

#include "widevine_cdm_version.h" // In SHARED_INTERMEDIATE_DIR. //TODO-ELECTRON: WHERE'S THIS, the file orginates from third_party/widevine/ ?
...
void AddAtomKeySystems(std::vector<KeySystemInfo>* key_systems_info) {
#if defined(ENABLE_PEPPER_CDMS)
